...
class EnvInfo(BaseTable):
    ...
    env_name = models.CharField(max_length=200, null=False, unique=True)
    base_url = models.CharField(max_length=200, null=False)
    simple_desc = models.CharField(max_length=200, null=False)
